...
data = dict(
    ...
    train=dict(
        type='CocoDataset',
        ann_file=
        'data/coco/TCT_JPEGImages/train30000-cat10.json',
    ...
    test=dict(
        type='CocoDataset',
        ann_file=
        'data/coco/TCT_JPEGImages/test10000-cat10.json',
        img_prefix='data/coco/',
        pipeline=[
            dict(type='LoadImageFromFile'),
            dict(
...
classes = ('normal', 'ascus', 'asch', 'lsil', 'hsil_scc_omn',
           'agc_adenocarcinoma_em', 'vaginalis', 'monilia',
           'dysbacteriosis_herpes_act', 'ec')
work_dir = 'work_dir/tct/faster_rcnn_r50_fpn_roi_attention_pixel_to_pixel_1x_tct_0510/'
gpu_ids = range(0, 1)
